...
func (c *tenantClient) ListTenants(ctx context.Context, in *ListTenantsRequest, opts ...grpc.CallOption) (*ListTenantsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Tenant_ListTenants_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tenantClient) ListPublicTenants(ctx context.Context, in *ListPublicTenantsRequest, opts ...grpc.CallOption) (*ListPublicTenantsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Tenant_ListPublicTenants_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Tenant_ListPublicTenants_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Tenant_ListPublicTenants_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
