...
type Remote_CommandStreamClient interface {
	Send(*CommandStreamRequest) error
...
func (x *remoteCommandStreamClient) Send(m *CommandStreamRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *remoteCommandStreamClient) Recv() (*CommandStreamResponse, error) {
...
func (x *remoteCommandStreamServer) Send(m *CommandStreamResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *remoteCommandStreamServer) Recv() (*CommandStreamRequest, error) {
