...
func request_Remote_CommandStream_0(ctx context.Context, marshaler runtime.Marshaler, client RemoteClient, req *http.Request, pathParams map[string]string) (Remote_CommandStreamClient, runtime.ServerMetadata, error) {
	...
	handleSend := func() error {
		var protoReq CommandStreamToServer
...
func RegisterRemoteHandlerServer(ctx context.Context, mux *runtime.ServeMux, server RemoteServer) error {
	...
	mux.Handle("POST", pattern_Remote_CommandStream_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterRemoteHandlerClient(ctx context.Context, mux *runtime.ServeMux, client RemoteClient) error {
	...
	mux.Handle("POST", pattern_Remote_CommandStream_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/aserto.remote.v1.Remote/CommandStream", runtime.WithHTTPPathPattern("/aserto.remote.v1.Remote/CommandStream"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Remote_CommandStream_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Remote_CommandStream_0(ctx, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Remote_CommandStream_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"aserto.remote.v1.Remote", "CommandStream"}, ""))
)

var (
	forward_Remote_CommandStream_0 = runtime.ForwardResponseStream
)
