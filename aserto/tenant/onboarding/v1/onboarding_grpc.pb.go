...
const (
	Onboarding_ClaimTenant_FullMethodName     = "/aserto.tenant.onboarding.v1.Onboarding/ClaimTenant"
	Onboarding_TenantAvailable_FullMethodName = "/aserto.tenant.onboarding.v1.Onboarding/TenantAvailable"
	Onboarding_InviteUser_FullMethodName      = "/aserto.tenant.onboarding.v1.Onboarding/InviteUser"
)
...
func (c *onboardingClient) ClaimTenant(ctx context.Context, in *ClaimTenantRequest, opts ...grpc.CallOption) (*ClaimTenantResponse, error) {
	...
	err := c.cc.Invoke(ctx, Onboarding_ClaimTenant_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *onboardingClient) TenantAvailable(ctx context.Context, in *TenantAvailableRequest, opts ...grpc.CallOption) (*TenantAvailableResponse, error) {
	...
	err := c.cc.Invoke(ctx, Onboarding_TenantAvailable_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *onboardingClient) InviteUser(ctx context.Context, in *InviteUserRequest, opts ...grpc.CallOption) (*InviteUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, Onboarding_InviteUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedOnboardingServer should be embedded to have
...
func _Onboarding_ClaimTenant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Onboarding_ClaimTenant_FullMethodName,
	}
...
func _Onboarding_TenantAvailable_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Onboarding_TenantAvailable_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Onboarding_InviteUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Onboarding_InviteUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Onboarding_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "aserto.tenant.onboarding.v1.Onboarding",
	...
	Metadata: "aserto/tenant/onboarding/v1/onboarding.proto",
}
