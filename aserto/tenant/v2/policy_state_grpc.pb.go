...
// UnimplementedPolicyStateServer should be embedded to have
...
func (UnimplementedPolicyStateServer) testEmbeddedByValue() {}
...
func RegisterPolicyStateServer(s grpc.ServiceRegistrar, srv PolicyStateServer) {
	// If the following call pancis, it indicates UnimplementedPolicyStateServer was
