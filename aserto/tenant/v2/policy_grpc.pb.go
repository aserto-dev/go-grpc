...
func (c *policyClient) ListPolicy(ctx context.Context, in *ListPolicyRequest, opts ...grpc.CallOption) (*ListPolicyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/aserto.tenant.policy.v2.Policy/ListPolicy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *policyClient) CreatePolicy(ctx context.Context, in *CreatePolicyRequest, opts ...grpc.CallOption) (*CreatePolicyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/aserto.tenant.policy.v2.Policy/CreatePolicy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *policyClient) DeletePolicy(ctx context.Context, in *DeletePolicyRequest, opts ...grpc.CallOption) (*DeletePolicyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/aserto.tenant.policy.v2.Policy/DeletePolicy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *policyClient) UpdatePolicy(ctx context.Context, in *UpdatePolicyRequest, opts ...grpc.CallOption) (*UpdatePolicyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/aserto.tenant.policy.v2.Policy/UpdatePolicy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Policy_ListPolicy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aserto.tenant.policy.v2.Policy/ListPolicy",
	}
...
func _Policy_CreatePolicy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aserto.tenant.policy.v2.Policy/CreatePolicy",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Policy_DeletePolicy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aserto.tenant.policy.v2.Policy/DeletePolicy",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Policy_UpdatePolicy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aserto.tenant.policy.v2.Policy/UpdatePolicy",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Policy_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "aserto.tenant.policy.v2.Policy",
