...
func file_aserto_tenant_v2_account_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_aserto_tenant_v2_account_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_aserto_tenant_v2_account_proto_msgTypes[1].Exporter = func(v any, i int) any {
