...
func (c *providerClient) ListProviders(ctx context.Context, in *ListProvidersRequest, opts ...grpc.CallOption) (*ListProvidersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/aserto.tenant.provider.v1.Provider/ListProviders", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *providerClient) GetProvider(ctx context.Context, in *GetProviderRequest, opts ...grpc.CallOption) (*GetProviderResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/aserto.tenant.provider.v1.Provider/GetProvider", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *providerClient) ListProviderKinds(ctx context.Context, in *ListProviderKindsRequest, opts ...grpc.CallOption) (*ListProviderKindsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/aserto.tenant.provider.v1.Provider/ListProviderKinds", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Provider_ListProviders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aserto.tenant.provider.v1.Provider/ListProviders",
	}
...
func _Provider_GetProvider_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aserto.tenant.provider.v1.Provider/GetProvider",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Provider_ListProviderKinds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aserto.tenant.provider.v1.Provider/ListProviderKinds",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
