...
const (
	PolicyBuilder_ListPolicyBuilders_FullMethodName  = "/aserto.tenant.policy_builder.v1.PolicyBuilder/ListPolicyBuilders"
	PolicyBuilder_CreatePolicyBuilder_FullMethodName = "/aserto.tenant.policy_builder.v1.PolicyBuilder/CreatePolicyBuilder"
	PolicyBuilder_DeletePolicyBuilder_FullMethodName = "/aserto.tenant.policy_builder.v1.PolicyBuilder/DeletePolicyBuilder"
)
...
func (c *policyBuilderClient) ListPolicyBuilders(ctx context.Context, in *ListPolicyBuildersRequest, opts ...grpc.CallOption) (*ListPolicyBuildersResponse, error) {
	...
	err := c.cc.Invoke(ctx, PolicyBuilder_ListPolicyBuilders_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *policyBuilderClient) CreatePolicyBuilder(ctx context.Context, in *CreatePolicyBuilderRequest, opts ...grpc.CallOption) (*CreatePolicyBuilderResponse, error) {
	...
	err := c.cc.Invoke(ctx, PolicyBuilder_CreatePolicyBuilder_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *policyBuilderClient) DeletePolicyBuilder(ctx context.Context, in *DeletePolicyBuilderRequest, opts ...grpc.CallOption) (*DeletePolicyBuilderResponse, error) {
	...
	err := c.cc.Invoke(ctx, PolicyBuilder_DeletePolicyBuilder_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedPolicyBuilderServer should be embedded to have
...
func (UnimplementedPolicyBuilderServer) testEmbeddedByValue() {}
...
func RegisterPolicyBuilderServer(s grpc.ServiceRegistrar, srv PolicyBuilderServer) {
	// If the following call pancis, it indicates UnimplementedPolicyBuilderServer was
...
func _PolicyBuilder_ListPolicyBuilders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PolicyBuilder_ListPolicyBuilders_FullMethodName,
	}
...
func _PolicyBuilder_CreatePolicyBuilder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PolicyBuilder_CreatePolicyBuilder_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PolicyBuilder_DeletePolicyBuilder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PolicyBuilder_DeletePolicyBuilder_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
