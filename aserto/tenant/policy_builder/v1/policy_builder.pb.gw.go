...
var filter_PolicyBuilder_ListPolicyBuilders_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}

func request_PolicyBuilder_ListPolicyBuilders_0(ctx context.Context, marshaler runtime.Marshaler, client PolicyBuilderClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq ListPolicyBuildersRequest
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_PolicyBuilder_ListPolicyBuilders_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	msg, err := client.ListPolicyBuilders(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
}

func local_request_PolicyBuilder_ListPolicyBuilders_0(ctx context.Context, marshaler runtime.Marshaler, server PolicyBuilderServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq ListPolicyBuildersRequest
		metadata runtime.ServerMetadata
	)
	...
	msg, err := server.ListPolicyBuilders(ctx, &protoReq)
	return msg, metadata, err
}

var filter_PolicyBuilder_CreatePolicyBuilder_0 = &utilities.DoubleArray{Encoding: map[string]int{"policy_builder": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
...
func request_PolicyBuilder_CreatePolicyBuilder_0(ctx context.Context, marshaler runtime.Marshaler, client PolicyBuilderClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq CreatePolicyBuilderRequest
		metadata runtime.ServerMetadata
	)
	if err := marshaler.NewDecoder(req.Body).Decode(&protoReq.PolicyBuilder); err != nil && !errors.Is(err, io.EOF) {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	if err := req.ParseForm(); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_PolicyBuilder_CreatePolicyBuilder_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	msg, err := client.CreatePolicyBuilder(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
}

func local_request_PolicyBuilder_CreatePolicyBuilder_0(ctx context.Context, marshaler runtime.Marshaler, server PolicyBuilderServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq CreatePolicyBuilderRequest
		metadata runtime.ServerMetadata
	)
	...
	msg, err := server.CreatePolicyBuilder(ctx, &protoReq)
	return msg, metadata, err
}

func request_PolicyBuilder_DeletePolicyBuilder_0(ctx context.Context, marshaler runtime.Marshaler, client PolicyBuilderClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq DeletePolicyBuilderRequest
		metadata runtime.ServerMetadata
		err      error
	)
	io.Copy(io.Discard, req.Body)
	...
	msg, err := client.DeletePolicyBuilder(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
}

func local_request_PolicyBuilder_DeletePolicyBuilder_0(ctx context.Context, marshaler runtime.Marshaler, server PolicyBuilderServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq DeletePolicyBuilderRequest
		metadata runtime.ServerMetadata
		err      error
	...
	msg, err := server.DeletePolicyBuilder(ctx, &protoReq)
	return msg, metadata, err
}

// RegisterPolicyBuilderHandlerServer registers the http handlers for service PolicyBuilder to "mux".
...
func RegisterPolicyBuilderHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PolicyBuilderServer) error {
	mux.Handle(http.MethodGet, pattern_PolicyBuilder_ListPolicyBuilders_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
	...
	mux.Handle(http.MethodPost, pattern_PolicyBuilder_CreatePolicyBuilder_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
	...
	mux.Handle(http.MethodDelete, pattern_PolicyBuilder_DeletePolicyBuilder_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
...
func RegisterPolicyBuilderHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterPolicyBuilderHandler(ctx, mux, conn)
}

// RegisterPolicyBuilderHandler registers the http handlers for service PolicyBuilder to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterPolicyBuilderHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterPolicyBuilderHandlerClient(ctx, mux, NewPolicyBuilderClient(conn))
}

// RegisterPolicyBuilderHandlerClient registers the http handlers for service PolicyBuilder
...
var (
	forward_PolicyBuilder_ListPolicyBuilders_0  = runtime.ForwardResponseMessage
	forward_PolicyBuilder_CreatePolicyBuilder_0 = runtime.ForwardResponseMessage
	forward_PolicyBuilder_DeletePolicyBuilder_0 = runtime.ForwardResponseMessage
)
