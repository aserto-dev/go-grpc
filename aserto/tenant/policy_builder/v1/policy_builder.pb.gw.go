...
var (
	filter_PolicyBuilder_ListPolicyBuilders_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_PolicyBuilder_ListPolicyBuilders_0(ctx context.Context, marshaler runtime.Marshaler, client PolicyBuilderClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ListPolicyBuildersRequest
...
func request_PolicyBuilder_DeletePolicyBuilder_0(ctx context.Context, marshaler runtime.Marshaler, client PolicyBuilderClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq DeletePolicyBuilderRequest
	var metadata runtime.ServerMetadata
...
func RegisterPolicyBuilderHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PolicyBuilderServer) error {
	...
	mux.Handle("POST", pattern_PolicyBuilder_CreatePolicyBuilder_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
	...
	mux.Handle("DELETE", pattern_PolicyBuilder_DeletePolicyBuilder_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
