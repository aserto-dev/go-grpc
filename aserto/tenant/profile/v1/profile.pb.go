...
var file_aserto_tenant_profile_v1_profile_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x7d, 0x42, 0xc6, 0x01, 0x92, 0x41, 0x82, 0x01,
	...
	0x12, 0x00, 0x5a, 0x3e, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61,
...
func file_aserto_tenant_profile_v1_profile_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_aserto_tenant_profile_v1_profile_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_aserto_tenant_profile_v1_profile_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_aserto_tenant_profile_v1_profile_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_aserto_tenant_profile_v1_profile_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_aserto_tenant_profile_v1_profile_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_aserto_tenant_profile_v1_profile_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_aserto_tenant_profile_v1_profile_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_aserto_tenant_profile_v1_profile_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_aserto_tenant_profile_v1_profile_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_aserto_tenant_profile_v1_profile_proto_msgTypes[9].Exporter = func(v any, i int) any {
