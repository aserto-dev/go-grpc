...
func (c *sourceCodeCtlClient) ListOrg(ctx context.Context, in *ListOrgRequest, opts ...grpc.CallOption) (*ListOrgResponse, error) {
	...
	err := c.cc.Invoke(ctx, SourceCodeCtl_ListOrg_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sourceCodeCtlClient) ListRepo(ctx context.Context, in *ListRepoRequest, opts ...grpc.CallOption) (*ListRepoResponse, error) {
	...
	err := c.cc.Invoke(ctx, SourceCodeCtl_ListRepo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sourceCodeCtlClient) GetRepo(ctx context.Context, in *GetRepoRequest, opts ...grpc.CallOption) (*GetRepoResponse, error) {
	...
	err := c.cc.Invoke(ctx, SourceCodeCtl_GetRepo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sourceCodeCtlClient) CreateRepo(ctx context.Context, in *CreateRepoRequest, opts ...grpc.CallOption) (*CreateRepoResponse, error) {
	...
	err := c.cc.Invoke(ctx, SourceCodeCtl_CreateRepo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sourceCodeCtlClient) ListTemplates(ctx context.Context, in *ListTemplatesRequest, opts ...grpc.CallOption) (*ListTemplatesResponse, error) {
	...
	err := c.cc.Invoke(ctx, SourceCodeCtl_ListTemplates_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sourceCodeCtlClient) GetProfile(ctx context.Context, in *GetProfileRequest, opts ...grpc.CallOption) (*GetProfileResponse, error) {
	...
	err := c.cc.Invoke(ctx, SourceCodeCtl_GetProfile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sourceCodeCtlClient) IsRepoConnected(ctx context.Context, in *IsRepoConnectedRequest, opts ...grpc.CallOption) (*IsRepoConnectedResponse, error) {
	...
	err := c.cc.Invoke(ctx, SourceCodeCtl_IsRepoConnected_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSourceCodeCtlServer should be embedded to have
...
func (UnimplementedSourceCodeCtlServer) testEmbeddedByValue() {}
...
func RegisterSourceCodeCtlServer(s grpc.ServiceRegistrar, srv SourceCodeCtlServer) {
	// If the following call pancis, it indicates UnimplementedSourceCodeCtlServer was
