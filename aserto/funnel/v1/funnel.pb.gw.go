...
var (
	filter_Funnel_StartWorkflow_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_Funnel_StartWorkflow_0(ctx context.Context, marshaler runtime.Marshaler, client FunnelClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_Funnel_StartWorkflow_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
var (
	filter_Funnel_StopWorkflow_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)
...
func request_Funnel_StopWorkflow_0(ctx context.Context, marshaler runtime.Marshaler, client FunnelClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_Funnel_StopWorkflow_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
var (
	filter_Funnel_ListenWorkflow_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_Funnel_ListenWorkflow_0(ctx context.Context, marshaler runtime.Marshaler, client FunnelClient, req *http.Request, pathParams map[string]string) (Funnel_ListenWorkflowClient, runtime.ServerMetadata, error) {
	var protoReq ListenWorkflowRequest
	var metadata runtime.ServerMetadata

	if err := req.ParseForm(); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_Funnel_ListenWorkflow_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	stream, err := client.ListenWorkflow(ctx, &protoReq)
	if err != nil {
...
func RegisterFunnelHandlerServer(ctx context.Context, mux *runtime.ServeMux, server FunnelServer) error {
	...
	mux.Handle("GET", pattern_Funnel_ListenWorkflow_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
func RegisterFunnelHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FunnelClient) error {
	...
	mux.Handle("GET", pattern_Funnel_ListenWorkflow_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/aserto.funnel.v1.Funnel/ListenWorkflow", runtime.WithHTTPPathPattern("/api/v2/funnel/listen"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Funnel_ListenWorkflow_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_Funnel_ListenWorkflow_0(ctx, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	...
	pattern_Funnel_ListenWorkflow_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "v2", "funnel", "listen"}, ""))
)
...
var (
	...
	forward_Funnel_ListenWorkflow_0 = runtime.ForwardResponseStream
)
