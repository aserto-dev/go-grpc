...
var file_aserto_api_v2_workflows_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x6e, 0x63, 0x65, 0x2a, 0x60, 0x0a, 0x0d, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f,
	0x77, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x1a, 0x0a, 0x16, 0x57, 0x4f, 0x52, 0x4b, 0x46, 0x4c,
	0x4f, 0x57, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x45, 0x5f, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e,
	0x10, 0x00, 0x12, 0x1a, 0x0a, 0x16, 0x57, 0x4f, 0x52, 0x4b, 0x46, 0x4c, 0x4f, 0x57, 0x5f, 0x53,
	...
	0x5f, 0x44, 0x4f, 0x4e, 0x45, 0x10, 0x02, 0x42, 0x41, 0x5a, 0x2f, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_aserto_api_v2_workflows_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_aserto_api_v2_workflows_proto_goTypes = []interface{}{
	(WorkflowState)(0),         // 0: aserto.api.v2.WorkflowState
	(*WorkflowEvent)(nil),      // 1: aserto.api.v2.WorkflowEvent
	(*PolicyDesiredState)(nil), // 2: aserto.api.v2.PolicyDesiredState
	(*structpb.Struct)(nil),    // 3: google.protobuf.Struct
	(*Policy)(nil),             // 4: aserto.api.v2.Policy
	(*Repository)(nil),         // 5: aserto.api.v2.Repository
	(*Source)(nil),             // 6: aserto.api.v2.Source
	(*Instance)(nil),           // 7: aserto.api.v2.Instance
}
var file_aserto_api_v2_workflows_proto_depIdxs = []int32{
	...
	3, // 1: aserto.api.v2.WorkflowEvent.event:type_name -> google.protobuf.Struct
	4, // 2: aserto.api.v2.PolicyDesiredState.policy:type_name -> aserto.api.v2.Policy
	5, // 3: aserto.api.v2.PolicyDesiredState.repository:type_name -> aserto.api.v2.Repository
	6, // 4: aserto.api.v2.PolicyDesiredState.source:type_name -> aserto.api.v2.Source
	7, // 5: aserto.api.v2.PolicyDesiredState.instance:type_name -> aserto.api.v2.Instance
