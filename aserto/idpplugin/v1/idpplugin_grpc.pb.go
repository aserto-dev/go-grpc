...
func (c *pluginClient) Import(ctx context.Context, opts ...grpc.CallOption) (Plugin_ImportClient, error) {
	...
	x := &pluginImportClient{ClientStream: stream}
	return x, nil
}
...
func (c *pluginClient) Export(ctx context.Context, in *ExportRequest, opts ...grpc.CallOption) (Plugin_ExportClient, error) {
	...
	x := &pluginExportClient{ClientStream: stream}
...
func (c *pluginClient) Delete(ctx context.Context, opts ...grpc.CallOption) (Plugin_DeleteClient, error) {
	...
	x := &pluginDeleteClient{ClientStream: stream}
	return x, nil
}
...
func _Plugin_Import_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(PluginServer).Import(&pluginImportServer{ServerStream: stream})
}
...
func _Plugin_Export_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(PluginServer).Export(m, &pluginExportServer{ServerStream: stream})
}
...
func _Plugin_Delete_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(PluginServer).Delete(&pluginDeleteServer{ServerStream: stream})
}
