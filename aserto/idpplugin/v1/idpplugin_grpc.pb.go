...
func (c *pluginClient) Info(ctx context.Context, in *InfoRequest, opts ...grpc.CallOption) (*InfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/aserto.idpplugin.v1.Plugin/Info", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pluginClient) Import(ctx context.Context, opts ...grpc.CallOption) (Plugin_ImportClient, error) {
	stream, err := c.cc.NewStream(ctx, &Plugin_ServiceDesc.Streams[0], "/aserto.idpplugin.v1.Plugin/Import", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *pluginClient) Export(ctx context.Context, in *ExportRequest, opts ...grpc.CallOption) (Plugin_ExportClient, error) {
	stream, err := c.cc.NewStream(ctx, &Plugin_ServiceDesc.Streams[1], "/aserto.idpplugin.v1.Plugin/Export", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *pluginClient) Delete(ctx context.Context, opts ...grpc.CallOption) (Plugin_DeleteClient, error) {
	stream, err := c.cc.NewStream(ctx, &Plugin_ServiceDesc.Streams[2], "/aserto.idpplugin.v1.Plugin/Delete", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *pluginClient) Validate(ctx context.Context, in *ValidateRequest, opts ...grpc.CallOption) (*ValidateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/aserto.idpplugin.v1.Plugin/Validate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Plugin_Info_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aserto.idpplugin.v1.Plugin/Info",
	}
...
func _Plugin_Validate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/aserto.idpplugin.v1.Plugin/Validate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
