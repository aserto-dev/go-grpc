...
func RegisterDiscoveryHandlerServer(ctx context.Context, mux *runtime.ServeMux, server DiscoveryServer) error {
	...
	mux.Handle("GET", pattern_Discovery_OPAInstanceDiscovery_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/aserto.discovery.policy.v2.Discovery/OPAInstanceDiscovery", runtime.WithHTTPPathPattern("/api/v2/discovery/{policy_name}/{instance_label}/opa"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Discovery_OPAInstanceDiscovery_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_Discovery_OPAInstanceDiscovery_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterDiscoveryHandlerClient(ctx context.Context, mux *runtime.ServeMux, client DiscoveryClient) error {
	...
	mux.Handle("GET", pattern_Discovery_OPAInstanceDiscovery_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/aserto.discovery.policy.v2.Discovery/OPAInstanceDiscovery", runtime.WithHTTPPathPattern("/api/v2/discovery/{policy_name}/{instance_label}/opa"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Discovery_OPAInstanceDiscovery_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Discovery_OPAInstanceDiscovery_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4, 2, 5}, []string{"api", "v2", "discovery", "policy_name", "instance_label", "opa"}, ""))
)

var (
	forward_Discovery_OPAInstanceDiscovery_0 = runtime.ForwardResponseMessage
)
