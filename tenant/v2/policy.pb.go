...
var file_tenant_v2_policy_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x22, 0x2b, 0x0a, 0x13, 0x44, 0x65, 0x6c, 0x65, 0x74,
	...
	0x6c, 0x69, 0x63, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x73, 0x0a, 0x13,
	...
	0x63, 0x79, 0x12, 0x2d, 0x0a, 0x06, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x15, 0x2e, 0x61, 0x73, 0x65, 0x72, 0x74, 0x6f, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	0x76, 0x31, 0x2e, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x52, 0x06, 0x66, 0x69, 0x65, 0x6c, 0x64,
	0x73, 0x22, 0x45, 0x0a, 0x14, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x6f, 0x6c, 0x69, 0x63,
	...
	0x52, 0x06, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x32, 0xf8, 0x06, 0x0a, 0x06, 0x50, 0x6f, 0x6c,
	...
	0x69, 0x63, 0x79, 0x42, 0xbd, 0x01, 0x5a, 0x35, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
	...
	0x61, 0x6e, 0x74, 0x2f, 0x76, 0x32, 0x3b, 0x74, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x92, 0x41, 0x82,
...
var file_tenant_v2_policy_proto_goTypes = []interface{}{
	...
	(*v1.Fields)(nil),            // 11: aserto.api.v1.Fields
}
var file_tenant_v2_policy_proto_depIdxs = []int32{
	...
	9,  // 5: aserto.tenant.v2.UpdatePolicyRequest.policy:type_name -> aserto.api.v2.Policy
	11, // 6: aserto.tenant.v2.UpdatePolicyRequest.fields:type_name -> aserto.api.v1.Fields
	9,  // 7: aserto.tenant.v2.UpdatePolicyResponse.policy:type_name -> aserto.api.v2.Policy
	3,  // 8: aserto.tenant.v2.Policy.ListPolicy:input_type -> aserto.tenant.v2.ListPolicyRequest
	0,  // 9: aserto.tenant.v2.Policy.CreatePolicy:input_type -> aserto.tenant.v2.CreatePolicyRequest
	5,  // 10: aserto.tenant.v2.Policy.DeletePolicy:input_type -> aserto.tenant.v2.DeletePolicyRequest
	7,  // 11: aserto.tenant.v2.Policy.UpdatePolicy:input_type -> aserto.tenant.v2.UpdatePolicyRequest
	4,  // 12: aserto.tenant.v2.Policy.ListPolicy:output_type -> aserto.tenant.v2.ListPolicyResponse
	1,  // 13: aserto.tenant.v2.Policy.CreatePolicy:output_type -> aserto.tenant.v2.CreatePolicyResponse
	6,  // 14: aserto.tenant.v2.Policy.DeletePolicy:output_type -> aserto.tenant.v2.DeletePolicyResponse
	8,  // 15: aserto.tenant.v2.Policy.UpdatePolicy:output_type -> aserto.tenant.v2.UpdatePolicyResponse
